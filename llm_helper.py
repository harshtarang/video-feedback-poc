...
def speech_to_text(audio_file, transcription_file, keyword_list, openai_model = True, file_name="good"):
    if openai_model:
...
def prompt_for_audio(aug_trans_file, output_file):
...
def prompt_for_text(gt_file, timed_transcription):
